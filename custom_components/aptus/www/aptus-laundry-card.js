...
`;let yt=class extends at{constructor(){super(...arguments),this._bookings=[],this._loading=!1}connectedCallback(){super.connectedCallback(),this.refresh()}async refresh(){this._loading=!0;try{this._bookings=await async function(t,e){return t.connection.sendMessagePromise({type:"aptus/laundry/bookings",entry_id:e})}(this.hass,this.entryId)}catch{this._bookings=[]}this._loading=!1}async _cancel(t){await this.hass.callService("aptus","cancel_laundry",{booking_id:t}),this.dispatchEvent(new CustomEvent("aptus-booking-changed",{bubbles:!0,composed:!0})),await this.refresh()}render(){return G`
      ...
      ${this._loading?G`<div class="loading">Loading...</div>`:0===this._bookings.length?G`<div class="empty">No upcoming bookings</div>`:this._bookings.map(t=>G`
              ...
              `)}
    `}};yt.styles=gt,t([pt({attribute:!1})],yt.prototype,"hass",void 0),t([pt()],yt.prototype,"entryId",void 0),t([ut()],yt.prototype,"_bookings",void 0),t([ut()],yt.prototype,"_loading",void 0),yt=t([ct("aptus-laundry-bookings")],yt);let ft=class extends at{constructor(){super(...arguments),this.count=10,this._slots=[],this._loading=!1}connectedCallback(){super.connectedCallback(),this.refresh()}async refresh(){this._loading=!0;try{this._slots=await async function(t,e,s=10){return t.connection.sendMessagePromise({type:"aptus/laundry/first_available",entry_id:e,first_x:s})}(this.hass,this.entryId,this.count)}catch{this._slots=[]}this._loading=!1}async _book(t){await this.hass.callService("aptus","book_laundry",{pass_no:t.pass_no,pass_date:t.date,group_id:t.group_id}),this.dispatchEvent(new CustomEvent("aptus-booking-changed",{bubbles:!0,composed:!0})),await this.refresh()}render(){return G`
